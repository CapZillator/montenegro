          ...
          <LocalizedLink key={listing.id} href={`/listings/${listing.id}`}>
            ...
            >
              ...
              <div className={classNames("flex items-center gap-2")}>
                ...
                />
                <p className="text-sm">
                  {publishedAtRelative.ago ? `${publishedAtRelative.ago} ` : null}{<span className={classNames({"capitalize": !publishedAtRelative.ago})}>{t(`date.${publishedAtRelative.i18nKey}`)}</span>}{publishedAtRelative.time ? ` ${publishedAtRelative.time}` : null}
                </p>
              </div>
            </div>
          </LocalizedLink>
